        ...
        if self.playing:
            ...
            for index, point in enumerate(self.points):
                if point in self.bounding_triangle:
                    ...
                    elif os.path.exists("stimuli_additional2/" + self.labels[index] + ".wav"):
                        file = "stimuli_additional2/" + self.labels[index] + ".wav"
                    elif os.path.exists("stimuli_additional2/" + self.labels[index] + ".mp3"):
                        file = "stimuli_additional2/" + self.labels[index] + ".mp3"
